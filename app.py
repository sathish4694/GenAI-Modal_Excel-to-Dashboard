...
# # Add the logo image from a URL
# logo_url = "https://images.miraclesoft.com/miracle-logo-dark.svg"  # URL of the logo
# st.image(logo_url, width=200)  # Display logo with a width of 200px
    ...
    try:
        ...
        if uploaded_file.name.endswith(".xlsx"):
            ...
            for sheet_name in sheet_names:
                ...
                st.write(f"Number of Rows: {sheet_data.shape[0]}")
                st.write(f"Number of Columns: {sheet_data.shape[1]}")
                st.write(f"Column Names: {sheet_data.columns.tolist()}")
...
# Footer with "Developed by" message and additional info (email or social media links)
st.markdown("""
    <div style="text-align: center; margin-top: 30px;">
        <p><b>Developed by Sathish Mattapalli</b></p>
    </div>
